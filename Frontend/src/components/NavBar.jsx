// No need to import a separate CSS file if all styles are with Tailwind
// import '../components/NavBar.css'; 
import './Navbar.css'
export default function NavBar() {
  return (
    // REMOVED: `fixed`
    // ADDED: `flex-wrap` to handle smaller screens, `z-10` for stacking context
    // The navbar now has a fixed height of h-20 (5rem)
    <div className="flex flex-wrap items-center justify-between h-20 w-full bg-gradient-to-r from-white via-stone-300 to-stone-400 z-10 p-4 shadow-md">
      
      {/* Logo Section */}
      <div className="flex items-center space-x-1 transition-all hover:scale-110 duration-300">
        <svg xmlns="http://www.w3.org/2000/svg" width="48" height="40" fill="currentColor" className="bi bi-lungs" viewBox="0 0 16 16">
        ...
        <p className="text-2xl font-bold" id="logo">X-Enhance</p>
      </div>
